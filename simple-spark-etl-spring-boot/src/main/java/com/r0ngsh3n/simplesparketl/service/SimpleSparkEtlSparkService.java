...
public class SimpleSparkEtlSparkService {
    ...
    @Async
    public CompletableFuture<String> runSparkClusterMode(String jobName, int partition){


    }

    @Async
    public CompletableFuture<String> runSparkStandalone(String jobName, int partition ) throws AnalysisException {
